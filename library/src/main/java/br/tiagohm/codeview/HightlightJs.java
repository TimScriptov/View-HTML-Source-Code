...
public class HightlightJs extends SyntaxHighlighter {
    ...
    public String getHtmlCode(String code, Language lang, int textSize) {
        String BODY_CSS = "margin: 0px !important;";
        String CODE_CSS = "font-size: " + textSize + "px !important; line-height: 1.2 !important;";
        String PRE_CSS = "margin: 0px !important; font-size: " + textSize + "px !important; line-height: 1.2 !important;";
        //private static String PRE_CLASS = "";
        String CODE_CLASS = lang.getLanguageName();

        String OTHERS_SCRIPTS;
        if (isShowLineNumber()) {
